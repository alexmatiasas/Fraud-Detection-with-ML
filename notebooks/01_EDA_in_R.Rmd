...
We'll require the next libraries for data manipulation and visualization. If they are not installed, the code will install them automatically.

```{r download-libraries}
required_packages <- c("tidyverse", "data.table", "gridExtra", "skimr", "ggcorrplot", "ranger", "naniar")
...
plot_c_block <- function(vars_subset) {
  c_long_block <- c_long %>%
    ...
    mutate(Variable = factor(Variable, levels = vars_subset))  # <-- Ordena como quieras
